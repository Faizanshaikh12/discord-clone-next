...
import {FormItem, Form, FormField, FormControl} from "../ui/form";
                ...
                <div className="flex flex-col w-full">
                    ...
                    {isPDF && (
                        <div className="relative flex items-center p-2 mt-2 rounded-md bg-background/10">
                            ...
                            />
                            <a href={fileUrl} target="_blank" rel="noreferrer noreferrer"
                               className="ml-2 text-sm text-indigo-500 dark:text-indigo">
                                PDF File
                            </a>
                        </div>
                    )}
